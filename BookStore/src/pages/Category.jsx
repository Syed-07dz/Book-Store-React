      ...
      {categories.map((category, index) => (
        <div key={index} className="mt-8">
          <div className="flex justify-between items-center px-4">
            <h3 className="font-semibold text-gray-700 text-xl">{category.title}</h3>
            <a href="#" className="text-blue-600 italic">See all</a>
          </div>
      ...
      {showPopup && selectedBook && (
        <div className="fixed inset-0 flex justify-center items-center bg-black bg-opacity-50 p-4">
          <div className="bg-white p-6 rounded-lg shadow-lg w-full max-w-md">
            ...
            <img src={selectedBook.image} alt={selectedBook.title} className="w-full h-48 object-cover rounded-lg mt-4" />
